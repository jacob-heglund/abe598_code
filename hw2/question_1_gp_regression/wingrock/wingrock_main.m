...
% this file simulates the dynamics of an airplane with wingrock and a PD controller
...
% the actual coefficients of the system dynamics
...
for t=t0:dt:tf
    ...
    %propagate state
    [x,xDot, pDot]=wingrock_sim(x,delta,dt,Wstar);
...
%% saving to disk
save('SIM', 'PDOT_REC', 'X_REC', 'XDOT_REC'); 
filename = 'sim5.csv';
% X_REC is phi
% XDOT_REC is p

data = [PDOT_REC, X_REC, XDOT_REC];
